...
exports.PostgresStoryRepository = void 0;
...
class PostgresStoryRepository {
    ...
    async getAll() {
      ...
      `;
            ...
            return Result_1.Result.ok(stories);
        }
        catch (error) {
            console.error("Error getting all stories:", error);
            return Result_1.Result.fail("Failed to get stories");
        }
    }
    async getById(id) {
        try {
      ...
      `;
            ...
            return Result_1.Result.ok(story);
        }
        catch (error) {
            console.error("Error getting story by id:", error);
            return Result_1.Result.fail("Failed to get story");
        }
    }
    async save(story) {
        ...
        `;
            ...
            return Result_1.Result.fail("Failed to save story");
        }
        finally {
            client.release();
        }
    ...
    async markAsViewed(storyId, userId) {
      ...
      `;
            ...
            return Result_1.Result.fail("Failed to mark story as viewed");
        }
    }
    /**
     * Save a story view record
     */
    async saveStoryView(client, storyId, userId) {
        const query = `
      INSERT INTO story_views (story_id, user_id, viewed_at)
      VALUES ($1, $2, NOW())
      ON CONFLICT (story_id, user_id) DO NOTHING
...
exports.PostgresStoryRepository = PostgresStoryRepository;
